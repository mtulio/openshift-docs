...
= Creating a VPC that uses local zones in AWS

You must create a Virtual Private Cloud (VPC) in Amazon Web Services (AWS) that uses local zones for your {product-title}
cluster to use. You can further customize the VPC to meet your requirements, including
...
* You opted in your AWS account to the local zone that will host your VPC.
